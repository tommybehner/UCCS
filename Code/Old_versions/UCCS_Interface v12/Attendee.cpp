...
void Attendee::registerConference(string attendeeName, string conferenceName)
{
    ...
    string str = "INSERT INTO Attendee_Conference(AttendeeName, Conference) VALUES('" + attendeeName + "', '" + conferenceName + "')";
...
void Attendee::unregisterConference(string attendeeName, string conferenceName)
{
    ...
    string str = "DELETE FROM Attendee_Conference WHERE AttendeeName='" + attendeeName + "' AND Conference='" + conferenceName + "'";
