...
public:
    ...
    void setupUi(QDialog *BusinessMenu)
    {
        ...
        label_BName = new QLabel(BusinessMenu);
        label_BName->setObjectName(QStringLiteral("label_BName"));
        label_BName->setGeometry(QRect(120, 50, 47, 13));
    ...
    void retranslateUi(QDialog *BusinessMenu)
    {
        ...
        label_BName->setText(QApplication::translate("BusinessMenu", "TextLabel", Q_NULLPTR));
    } // retranslateUi
